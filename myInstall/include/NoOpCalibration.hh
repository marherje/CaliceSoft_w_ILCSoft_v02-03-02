#ifndef _NoOpCalibration_hh_
#define _NoOpCalibration_hh_
 ...
 * Does nothing.
 */
class NoOpCalibration : public Calibration
{
public:
   ...
   */
  Float_t getCalibratedValue(UInt_t module_index, UInt_t module_type, UInt_t cell_index, Float_t adc_value) const {return adc_value;};
  ...
  Int_t  getMiniumADCForMipThreshold(Float_t mip_energy_fraction) const {
    return static_cast<Int_t>(floor(mip_energy_fraction));
  }
