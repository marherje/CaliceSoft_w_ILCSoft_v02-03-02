#ifndef EUDAQEventBuilder2018_cosmics_h
#define EUDAQEventBuilder2018_cosmics_h 1
...
namespace CALICE{
  ...
  class EUDAQEventBuilder2018_cosmics : public Processor {
  ...
  public:
     ...
     */
    virtual Processor*  newProcessor() { return new EUDAQEventBuilder2018_cosmics;}
    EUDAQEventBuilder2018_cosmics() ;
    ~EUDAQEventBuilder2018_cosmics() ;
