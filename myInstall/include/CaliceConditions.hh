#ifndef CaliceConditions_h
#define CaliceConditions_h 1
...
#define CALICECONDITIONSNINT 22
#define CALICECONDITIONSNFLOAT 0
#define CALICECONDITIONSNDOUBLE 0

using namespace lcio;

namespace CALICE {

class CaliceConditions;
...
class CaliceConditions: public LCFixedObject<CALICECONDITIONSNINT,CALICECONDITIONSNFLOAT,CALICECONDITIONSNDOUBLE> {
...
public: 
  ...
  /** constructor, CaliceCondition is initialized with the parameters given
    ...
    */
  CaliceConditions(int moduleNr, unsigned moduleID, int calibStart, int calibWidth, bool calibEnable,
  ...
  CaliceConditions(LCObject* obj): LCFixedObject<CALICECONDITIONSNINT,CALICECONDITIONSNFLOAT,CALICECONDITIONSNDOUBLE>(obj) {};

  virtual ~CaliceConditions() {};
