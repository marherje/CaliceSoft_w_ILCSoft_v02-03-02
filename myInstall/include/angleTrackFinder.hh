...
namespace CALICE {
  ...
  class angleTrackFinder : public marlin::Processor 
  {
    ...
    public:
	  ...
	  */
      virtual Processor* newProcessor() { return new angleTrackFinder;}
      /**Default constructor
	  */
      angleTrackFinder();
      /**Destructor
	  ...
	  */
      ...
      //EVENT::CalorimeterHit* mySortInZFunction(EVENT::CalorimeterHit* aHit, EVENT::CalorimeterHit* bHit); 
      //bool operator()(EVENT::CalorimeterHit* aHit, EVENT::CalorimeterHit* bHit); 
      //bool mySortInZFunction(EVENT::CalorimeterHit *aHit, EVENT::CalorimeterHit *bHit);
      //static bool compareMyDataPredicate(EVENT::CalorimeterHit *aHit, EVENT::CalorimeterHit *bHit);
    private:
	  ...
	  */
      ...
      EVENT::ClusterVec findTrackClusters(LCTypedVector<CalorimeterHit>* hcalVec);
      EVENT::ClusterVec findTrackClustersCoarse(LCTypedVector<CalorimeterHit>* hcalVec);
      /**Select good tracks
	  ...
	  */
      //EVENT::ClusterVec selectTrackClusters(EVENT::ClusterVec clusterVec, const std::string trackSelectionMode);
      EVENT::ClusterVec selectTrackClusters(EVENT::ClusterVec clusterVec, const std::string trackSelectionMode);
      EVENT::ClusterVec mergeCoarseClusters(EVENT::ClusterVec goodclusterVec, EVENT::ClusterVec clusterCoarseVec,const std::string trackSelectionMode);
	  ...
	  */
      ...
      EVENT::ClusterVec getRemainingHitsOfTrackSegment(EVENT::ClusterVec selectedTrackClusters);
